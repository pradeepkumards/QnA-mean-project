const groupsModel = require('./topics.model');
...
function createGroup(userId, newGroupObj, done) {
  ...
  groupObj.topicId = newGroupObj.groupId;
  ...
  groupObj.save((err, savedGroupObj) => {
    ...
    return done(null, { response: savedGroupObj, message: "Topic added sucessfully." });
  });
}
