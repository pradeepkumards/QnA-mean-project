...
function addGroup(userId, newGroupObj, topicId, done) {
  ...
  groupsService.addGroup(userId, newGroupObj, topicId, done);
}
...
// Handler to get questions by topicId
function getGroupBytopicId(userId, groupId, done) {
  logger.info("Inside controller method - get group by groupId");
  groupsService.getGroupBytopicId(userId, groupId, done);
}
